...
calendar.timetableSettings.startTime = 540;
calendar.timetableSettings.endTime = 1060;
...
resource.firstName = "Gretchen";
resource.lastName = "Jones";
resource.tag = 0;
calendar.schedule.contacts.add(resource);

resource = new p.Contact();
resource.firstName = "Katie";
resource.lastName = "Leidhecker";
resource.tag = 1;
calendar.schedule.contacts.add(resource);

resource = new p.Contact();
resource.firstName = "Lexie";
resource.lastName = "Khetani";
resource.tag = 2;
calendar.schedule.contacts.add(resource);
...
datePicker.listSettings.visibleCells = datePicker.listSettings.numberOfCells = 21;
